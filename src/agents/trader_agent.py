...
class TraderAgent(Agent):
    ...
    def execute(self, research_consensus, open_positions, diversification_config=None):
        ...
        prompt = (
            ...
            "IMPORTANT: Always use the standard notation for currency pairs (e.g., EURUSD, not USDEUR). Your broker uses the '-ECN' suffix, so all currency pairs should end with '-ECN' (e.g., 'EURUSD-ECN').\n\n"
