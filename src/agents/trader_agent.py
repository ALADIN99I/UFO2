...
class TraderAgent(Agent):
    ...
    def execute(self, research_consensus, open_positions, diversification_config=None):
        ...
        prompt = (
            ...
            "IMPORTANT: Do NOT consider economic calendar events or market sentiment. Base decisions ONLY on UFO strength data. "
            "Your decisions should balance QUALITY UFO analysis with DIVERSIFICATION needs for optimal risk management.\n\n"
            ...
            "• Each trade must have strong UFO analytical support\n"
            ...
            "NOTE: Ignore economic events and market sentiment - focus purely on UFO currency strength relationships.\n\n"
            f"Account Balance: ${balance} - Risk tolerance: 0.8-1.2% per trade, max 4.5% total portfolio risk.\n\n"
            f"UFO-Based Research Consensus:\n{research_consensus}\n\n"
